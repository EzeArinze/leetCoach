...
function SolutionPage() {
  ...
  return (
    <section className="flex-1 flex flex-col items-center  bg-gray-100 dark:bg-gray-950 rounded-lg shadow-md m-2 p-6 border-t md:border-t-0 md:border-l border-gray-200 dark:border-gray-800 h-[95%]">
